...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/vs.js":[function(require,module,exports) {
/* global $ */
var choices = [];
...
function performNextAction() {
  if (choices.length < 2) {
    confirm("Player ".concat(choices.length + 1, ", choose your character!"));
    $('.grid-container').one('click', 'img', selectCharacter);
  } else {
    choices.forEach(function (choice, index) {
      return localStorage.setItem("Player".concat(index + 1), choice);
    });
    window.location = 'selectbg.html';
  }
}

document.querySelector('#charactersubmit').addEventListener('click', performNextAction); // Player 1 clicks NEXT
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/vs.js"], null)
//# sourceMappingURL=/vs.4372b7b5.map